...
function AppLogo() {
  return (
    ...
    >
      ...
      />
      <path
        d="M5.67793 11.0219L1.78131 14.9185C1.78131 17.5905 2.4493 20.1511 3.67396 22.3777L12.7475 13.9722V0H11.0219C4.95427 0 0 4.89861 0 11.0219H5.67793V11.0219Z"
        fill="#53B1FD"
      />
    </svg>
  );
